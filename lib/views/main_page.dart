...
class _MainPageState extends State<MainPage> {
  ...
  // Xử lý nút back - pop trong tab trước, nếu không thể thì thoát app
  Future<bool> _onWillPop() async {
    ...
    return true; // Cho phép thoát app
  }

  // Build navigator cho mỗi tab
        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          onTap: (index) {
            if (index == _currentIndex) {
              // Double tap on same tab - pop to root of that tab
